...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
		...
		<form name="form1" method="post" id="form1" action="">
                   ...
                   <tr><td>&nbsp;</td>
                       <td>Sales ID</td>
                       <td><input name="stock_id" type="text" readonly readonly="readonly" id="stockid" maxlength="200"  class="round default-width-input" value="<?php echo $line->transactionid ; ?> "/>
                      </td>
                   <td>&nbsp;</td></tr>
                    <tr><td>&nbsp;</td>
					<td>Customer</td>
                      <td><input name="customer" type="text" id="customer" maxlength="200" readonly class="round default-width-input" value="<?php echo $line->customer_id  ; ?> "/></td>
                   <td>Total </td>
