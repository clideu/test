	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				...
				<li><a href="page-full-width.php" class="sales-tab">Issuance</a></li>
				<li><a href="page-full-width.php" class="customers-tab">Customers</a></li>
				<li><a href="page-other.php" class="purchase-tab">Receive Items</a></li>
