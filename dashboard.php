			...
			<div class="side-content fr">
					...
					<div class="content-module-heading cf">
						...
						<div class="content-module-main cf">
								...
								<table style="width:350px; float:left;" border="0" cellpadding="0" cellspacing="0">
								  ...
								  <tr>
									<td align="left">Total Issuance Transactions </td>
				...
				<table style="width:600px; margin-left:50px; float:left;" border="0" cellspacing="0" cellpadding="0">
				  <tr>
					...
					<td width="150" align="left">Add Receiving(Ctrl+1)</td>
				
                                        
				  </tr>
				  <tr><td>&nbsp;</td>
                                      	<td width="250" align="left">Add Stock(Ctrl+2)</td>
					<td align="left">Add Issuance(Ctrl+3)</td>
				  ...
				  <tr><td>&nbsp;</td>
                                      <td align="left">View Issuance(Ctrl+8)</td>
					<td align="left">View Receiving (Ctrl+9) </td>
