...
<head>
	<meta charset="utf-8">
	<title>ACON - Login to Control Panel</title>
...
<?php include_once("analyticstracking.php") ?>
	...
	<div id="header">
		...
		<div class="page-full-width cf">
			...
			<a href="http://acon.com/" id="company-branding" class="fr"  target="blank"><img src="upload/Acon_Logo.png" alt="Point of Sale" /></a>
