		...
		<div class="page-full-width cf">
			...
			<div class="side-content fr">
				...
				<table style="width:600px; margin-left:50px; float:left;" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td>Old Password</td><td><input type="password" name="old_pass" readonly></td></tr>
                                  <tr><td>&nbsp;</td><td>&nbsp;</td></tr><tr>
                                      <td>New Password</td><td><input type="password" name="new_pass" readonly ></td></tr>
                                      <tr><td>&nbsp;</td><td>&nbsp;</td></tr><tr>
                                      <td>Confirm Password</td><td><input type="password" name="confirm_pass" readonly></td>
				  </tr>
