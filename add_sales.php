...
$(function() {
	    ...
	    $("#category").autocomplete("category2.php", {
		width: 160,
		autoFill: true,
		mustMatch: true,
		selectFirst: true
				...
				<form name="form1" method="post" id="form1" action="">
                  ...
                  <table class="form" >
                      <tr>
                        ...
                        <tr>
                        <td><input name=""  type="text" id="category"  maxlength="200"  class="round default-width-input " style="width: 150px"   /></td>
                        <td><input name=""  type="text" id="item"  maxlength="200"  class="round default-width-input " style="width: 150px"   /></td>
                        <td><input name=""  type="text" id="uom"  maxlength="200"  class="round default-width-input " style="width: 150px"   /></td>
