		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<ul>
                    ...
                    <li><a href="add_transfers.php">Add/Receive Transfers </a></li>
				</ul>
				...
				<form name="form1" method="post" id="form1" action="">
                  ...
                  <table class="form "  border="0" cellspacing="0" cellpadding="0">
                    <tr>  <td>&nbsp; </td> <td>&nbsp; </td>
                      ...
                      <td>&nbsp; </td>  <td>&nbsp; </td>  <td ><span class="man">*</span>Reference No:<input type="hidden"> </td> 
                      
                      <td><input name="bill_no" placeholder="ENTER REFERENCE NO" type="text" id="bill_no" maxlength="200"  class="round default-width-input" style="width:120px " /></td>
                       
                    </tr>
                    <tr>  <td>&nbsp; </td> <td>&nbsp; </td>
                      <td><span class="man">*</span>From Store:</td>
                      <td>
                        <select name="fromstor1e" size="1" id="fromstore">
                          <option value="1">Labo</option>
                          <option value="2">Madokay</option>
                          <option value="3">MD Santos</option>
                          <option value="4">Sto Cristo</option>
                        </select>
                      </label></td>
                       
                      <td><span class="man">*</span>To Store:</td>
                      <td><select name="fromstore2" size="1" id="fromstore2">
                        <option value="1">Labo</option>
                        <option value="2">Madokay</option>
                        <option value="3">MD Santos</option>
                        <option value="4">Sto Cristo</option>
                  ...
                  <!--table class="form">
                    ...
                    <td>Discount Amount:<input type="text"  onkeypress="return numbersonly(event);"  onkeyup=" discount_as_amount(); "  class="round" id="disacount_amount" name="dis_amount" >               
                        ...
                        <input type="text" id="main_grand_total" readonly class="round default-width-input"  style="text-align:right;width: 120px" >
                    </td>  <td>&nbsp; </td>
                     <td>Description</td>
                 ...
                 <td>Tax Description:<input type="text" name="tax_dis"> </td>
                  ...
                  <table class="form">
                    <tr>
                     <td>
                        <input  class="button round blue image-right ic-add text-upper" type="submit" name="Submit" value="Transfer">
                        <!--input  class="button round blue image-right ic-add text-upper" type="submit" name="Submit1" value="Add"-->
                     </td><td>			(Control + S)
