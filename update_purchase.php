	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				...
				<li><a href="view_purchase.php" class="active-tab purchase-tab">Receiving Items</a></li>
	...
	<div id="content">
		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<h3>RECEIVING Management</h3>
				<ul>
					<li><a href="add_purchase.php">Add Receiving</a></li>
					<li><a href="view_purchase.php">View Receiving </a></li>
				</ul>
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Update RECEIVING</h3>
				...
				<form name="form1" method="post" id="form1" action="">
                  ...
                  <table class="form"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
					  ...
					  ?>
                      <td>Stock ID:</td>
                      <td><input name="stockid" type="text" id="stockid" readonly maxlength="200"  class="round default-width-input" style="width:130px "  value="<?php echo $line->stock_id  ; ?>" /></td>
                  ...
                  <table class="form" id="display" style="display:none">
                      ...
                      <td><input name=""  type="text" id="cost" readonly maxlength="200"  class="round my_with"  value="<?php echo $category; ?>" /></td>
                  ...
                  <input type="hidden" id="edit_guid">
					...
					for($i=1; $i<=$max; $i++)
					{
                     ...
                     <tr>
                         ...
                         <td><input name="stock_name[]"  type="text" id="<?php echo $item."st"?>" maxlength="100" style="width: 150px" readonly  class="round "
                      ...
                      <td><input name="cost[]"  type="text" id="<?php echo $item."c"?>" maxlength="20"  class="round my_with" 
                                 value="<?php echo $line1->company_price ; ?>" readonly onkeypress="return numbersonly(event)" /></td>
                   
                        
                            
                      <td><input name="sell[]"  type="text" id="<?php echo $item."s"?>" maxlength="20" readonly class="round my_with" 
                  ...
                  <table class="form">
                    ...
                    <td>Balance:<input type="text"  class="round" value="<?php echo $line->balance ; ?>" id="balance" name="balance" >               
                      ...
                      <td>&nbsp; </td><td>&nbsp; </td><td>&nbsp; </td><td>&nbsp; </td>
                       <td>Grand Total:<input type="hidden" readonly id="grand_total" value="<?php echo $line->subtotal ; ?>" name="subtotal" > 
