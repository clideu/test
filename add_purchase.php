	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				...
				<li><a href="view_purchase.php" class="active-tab purchase-tab">Receive Items</a></li>
		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<ul>
                    ...
                    <li><a href="add_transfers.php">Receive Transfers </a></li>
				</ul>
                    ...
                    <tr> <td>&nbsp; </td>
                      ...
                      <td>&nbsp; </td><td>&nbsp; </td><td>&nbsp; </td><td>&nbsp; </td>
                       <td>Grand Total:<input type="hidden" readonly id="grand_total" name="subtotal" > 
                           <input type="text" id="main_grand_total" class="round default-width-input" onkeypress="return numbersonly(event)" readonly style="text-align:right;width: 120px" >
                    </td>
                  </tr> </table> 
                  <table>
                  <tr> <td>Mode &nbsp;</td><td>
