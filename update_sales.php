...
<head>
	<meta charset="utf-8">
	<title>ACON - Update Supplier</title>
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				...
				<li><a href="view_sales.php" class="active-tab sales-tab">Issuance</a></li>
				<li><a href="view_customers.php" class=" customers-tab">Customers</a></li>
				<li><a href="view_purchase.php" class="purchase-tab">Receving Items</a></li>
	...
	<div id="content">
		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<h3>ISSUANCE Management</h3>
				<ul>
					<li><a href="add_sales.php">Add Issuance</a></li>
					<li><a href="view_sales.php">View Issuance</a></li>
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Update ISSUANCE</h3>
				...
				<form name="form1" method="post" id="form1" action="">
                  ...
                  <table class="form"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td><input name="stockid" type="text" id="stockid" readonly maxlength="200"  class="round default-width-input" style="width:130px "  value="<?php echo $line->transactionid   ; ?>" /></td>
                  ...
                  <table class="form" id="display" style="display:none">
                      ...
                      <td><input name=""  type="text" id="sell" readonly maxlength="200"  class="round  my_with"  value="<?php echo $category; ?>" /></td>
                            
                                        
                      <td><input name=""  type="text" id="stock" readonly maxlength="200"  class="round  my_with"  value="<?php echo $category; ?>" /></td>
                  ...
                  <input type="hidden" id="edit_guid">
					...
					for($i=1; $i<=$max; $i++)
					{
                     ...
                     <tr>
                         ...
                         <td><input name="stock_name[]"  type="text" id="<?php echo $item."st"?>" maxlength="20" style="width: 150px" readonly  class="round "
                                 value="<?php echo $line1->stock_name ; ?>" /></td>
                  
                      <td><input name="quantity[]"  type="text" id="<?php echo $item."q"?>" maxlength="20"  class="round my_with" 
                                 value="<?php echo $line1->quantity ; ?>" readonly onkeypress="return numbersonly(event)" /></td>
                
                  
                   
                        
                            
                      <td><input type="hidden" name="s_id[]" value="<?php echo $line1->id; ?>"> <input name="sell[]"  type="text" id="<?php echo $item."s"?>" maxlength="20" readonly class="round my_with" 
					  value="<?php echo $line1->selling_price; ?>" onkeypress="return numbersonly(event)"  /></td>
                      <td><input name="stock[]"  type="text" id="<?php echo $item."p"?>" readonly maxlength="200"   class="round  my_with"  value="<?php $quantity = $db->queryUniqueValue("SELECT quantity FROM stock_avail WHERE name='".$line1->stock_name."'"); echo $quantity; ?>" /></td>
                   
                      <td><input name="total[]"  type="text" id="<?php echo $item."to"?>" readonly maxlength="20" style="margin-left:20px;width: 120px"  class="round " 
                  ...
                  <table class="form">
                    ...
                    <td>Discount Amount:<input type="text" readonly  value="<?php echo $line->dis_amount ; ?>" onkeypress="return numbersonly(event);"  onkeyup=" discount_as_amount(); " class="round" id="disacount_amount" name="dis_amount" >               
                      </td>
                     <td>&nbsp; </td><td>&nbsp; </td>
                        <td>Grand Total:<input type="hidden" readonly  value="<?php echo $line->grand_total ; ?>" id="grand_total" name="subtotal" > 
                        <input type="text" id="main_grand_total" readonly  value="<?php echo $line->grand_total ; ?>" class="round default-width-input"  style="text-align:right;width: 120px" >
                    </td>
                      <td>Description</td>
                  <td><textarea name="description"><?php echo $line->description ; ?></textarea></td>
                    ...
                    <td>Balance:<input type="text"  class="round" value="<?php echo $line->balance ; ?>" id="balance" name="balance" >               
                      ...
                      <td>Payable Amount:<input type="hidden" readonly id="grand_total"  > 
                        <input type="text" id="payable_amount" value="<?php echo $line->subtotal ; ?>" readonly name="payable" class="round default-width-input"  style="text-align:right;width: 120px" >
                   </td>
                  </tr> </table> 
                  <table>
                  <tr> <td>Mode &nbsp;</td><td>
