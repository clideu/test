...
<head>
	<meta charset="utf-8">
	<title>ACON - Update Payment</title>
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				...
				<li><a href="view_purchase.php" class="purchase-tab">Receiving Items</a></li>
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
		...
		<form name="form1" method="post" id="form1" action="">
                   ...
                   <tr><td>&nbsp;</td>
                       <td>Sales ID</td>
                       <td><input name="stock_id" type="text" readonly readonly="readonly" id="stockid" maxlength="200"  class="round default-width-input" value="<?php echo $line->stock_id ; ?> "/>
                      </td>
                   <td>&nbsp;</td></tr>
                    <tr><td>&nbsp;</td>
					<td>Customer</td>
                      <td><input name="customer" type="text" id="customer" maxlength="200" readonly class="round default-width-input" value="<?php echo $line->stock_supplier_name  ; ?> "/></td>
                   <td>Total </td>
                      <td><input name="total"  type="text" id="tatal" maxlength="20" readonly  class="round default-width-input" 
					  value="<?php echo $line->subtotal ; ?>" /></td>
                    </tr>
                    
                    <tr><td>&nbsp;</td>
                             <td>Paid </td>
                      <td><input name="paid"  type="text" id="paid" maxlength="20" readonly  class="round default-width-input" 
                                 value="<?php echo $line->payment ; ?>" onkeypress="return numbersonly(event)" /></td>
                    <td>Balance </td>
                    <td><input name="balance"  type="text" id="balance" readonly maxlength="20"  class="round default-width-input" 
